  ...
  if (props.list.id) {
    return (
      <Container maxWidth="lg" className={classes.container}>
        ...
        {props.list.todoList.length === 0 &&
        <div>
          <h5 style={{textAlign: 'center', padding: 25}}>Add the details of your event!!</h5>
        </div>
        }
    ...
    return (
      <div>
        <h3 style={{textAlign: 'center', padding: 25}}>No saved Event found, please first add an Event left menu
           Add your list.</h3>
      </div>
    )
  }
