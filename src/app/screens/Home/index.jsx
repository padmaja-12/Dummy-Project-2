...
function HomePage(props) {
    ...
    if ((selectedListEditItemIndex % 1) === 0) {
      ...
      return (
        <Dialog open={showEditTodoDialog} aria-labelledby="form-dialog-title">
          ...
          <DialogContent>
            <DialogContentText>
            You can edit Event information here.
            </DialogContentText>
            <TextField
              autoFocus
              defaultValue={title}
  ...
  function renderNewTodoDialog() {
    ...
    return (
      <Dialog open={showNewTodoDialog} aria-labelledby="form-dialog-title">
        <DialogTitle id="form-dialog-title">Add Chores</DialogTitle>
        <DialogContent>
          <DialogContentText>
          Enter the required information to add Todo Item and click SAVE.
          </DialogContentText>
          <TextField
            autoFocus
            defaultValue={title}
  ...
  function renderNewListDialog() {
    ...
    return (
      <Dialog open={showNewListDialog} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
          <DialogContentText>
          Enter the name of Event and click Save.
          </DialogContentText>
          <TextField
            autoFocus
            defaultValue={title}
  ...
  function renderLists() {
    if (todoLists.length > 0) {
      ...
      return (
        <div>
          <span className={classes.emptyListText}>There is no Event registered.</span>
        </div>
      )
    }
  }
